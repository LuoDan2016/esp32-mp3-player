...
WifiStation::WifiStation() : Wifi(WIFI_MODE_STA)
{
    /* EMPTY */
    // Wifi constructor initializes default configuration
}

void WifiStation::SetConfig(const uint8_t ssid[32], const uint8_t password[64], const bool bssid_set)
{
...
void WifiStation::ScanSpecific(uint8_t ssid[32])
{
    // Configure
    wifi_scan_config_t scan_config;
...
void WifiStation::SetStationIpInfo(const char *ip, const char *gw, const char *nm)
{
    SetIpInfo(WIFI_MODE_STA, ip, gw, nm);
}
